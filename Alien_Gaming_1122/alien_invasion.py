...
def run_game():
    ...
    bullet_images = [bullet_snow, bullet_fire]
    ...
    btn_volume_rect = pygame.Rect(screen.get_rect().centerx - btn_volume_image_width / 2 + 420,
                                  screen.get_rect().centery - btn_volume_image_height / 2 + 370,
    ...
    buttons = {'start': start_button, 'volume_button_image': volume_button}
    ...
    while True:
        ...
        if stats.game_active:
            ...
            gf.update_bullets(stats, aliens, bullets, explosions, all_images['explosion'], all_sounds['bomb'])
            gf.update_gifts(gifts, ship, screen, all_images['gift'], all_sounds['get_buff'])
            explosions.update()
