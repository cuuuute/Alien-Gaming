...
def create_fleet(screen, stats, aliens, alien_image):
    if stats.game_difficulty % 5:
        ...
        create_alien(screen, stats, aliens, 0, 0, 4, alien_image)
...
def init_gift():
    ...
    image4 = pygame.image.load('./images/add_heart.png').convert_alpha()
...
def init_alien():
    ...
    image4 = pygame.image.load('./images/alien_boss.png').convert_alpha()
